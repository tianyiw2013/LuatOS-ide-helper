...
--fatfs.mount(mode,mount_point, spiid_or_spidevice, spi_cs, spi_speed, power_pin, power_on_delay, auto_format) - 挂载fatfs
--传入值：
...
--fatfs.unmount(mount_point) - 取消挂载fatfs
--传入值：
...
--fatfs.getfree(mount_point) - 获取可用空间信息
--传入值：
