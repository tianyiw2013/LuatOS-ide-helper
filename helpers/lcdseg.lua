...
--lcdseg.setup(bias, duty, vlcd, com_number, fresh_rate, com_mark, seg_mark) - 初始化lcdseg库
--传入值：
...
--lcdseg.power(en) - 启用或禁用lcdseg的输出
--传入值：
--int 1启用,0禁用
--返回值：
--bool 成功与否
...
--lcdseg.seg_set(com, seg, en) - 设置具体一个段码的状态
--传入值：
--int COM号
--int seg号 要更改的字段的位索引
--int 1启用,0禁用
