...
--fdb.kvdb_init(name, partition) - 初始化kv数据库
--传入值：
...
--fdb.kv_get(key, skey) - 根据key获取对应的数据
--传入值：
--string key的名称,必填,不能空字符串
...
--fdb.kv_next(iter) - kv迭代器获取下一个key
--传入值：
