...
--cc.lastNum() - 获取最后一次通话的号码
--返回值：
--string 获取最后一次通话的号码
function cc.lastNum() end

--cc.dial(sim_id, number) - 拨打电话
--传入值：
--number sim_id
--string 电话号码
--返回值：
...
--cc.hangUp(sim_id) - 挂断电话
--传入值：
--number sim_id
function cc.hangUp(sim_id) end

--cc.accept(sim_id) - 接听电话
--传入值：
--number sim_id
--返回值：
--bool 接听电话成功与否
...
--cc.record(on_off,upload_zbuff1, upload_zbuff2, download_zbuff1, download_zbuff2) - 录音通话
--传入值：
