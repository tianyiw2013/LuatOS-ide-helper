...
--lora.init(ic, loraconfig,spiconfig) - lora初始化
--传入值：
...
--lora.set_txconfig(ic, txconfig) - lora配置发送参数
--传入值：
--string lora 型号，当前支持：<br>llcc68<br>sx1268
...
--lora.set_rxconfig(ic, set_rxconfig) - lora配置接收参数
--传入值：
--string lora 型号，当前支持：<br>llcc68<br>sx1268
