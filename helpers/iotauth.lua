...
--iotauth.aliyun(product_key, device_name,device_secret,method,cur_timestamp) - 阿里云物联网平台三元组生成
--传入值：
--string product_key
--string device_name
...
--iotauth.onenet(produt_id, device_name,key,method,cur_timestamp,version) - 中国移动物联网平台三元组生成
--传入值：
...
--iotauth.iotda(device_id,device_secret,cur_timestamp) - 华为物联网平台三元组生成
--传入值：
--string device_id
--string device_secret
...
--iotauth.qcloud(product_id, device_name,device_secret,method,cur_timestamp,sdk_appid) - 腾讯联网平台三元组生成
--传入值：
...
--iotauth.tuya(device_id,device_secret,cur_timestamp) - 涂鸦联网平台三元组生成
--传入值：
--string device_id
--string device_secret
...
--iotauth.baidu(iot_core_id, device_key,device_secret,method,cur_timestamp) - 百度物联网平台三元组生成
--传入值：
--string iot_core_id
--string device_key
--string device_secret
