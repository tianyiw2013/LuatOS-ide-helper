...
--fskv.sett(key, skey, value) - 设置table内的键值对数据
--传入值：
--string key的名称,必填,不能空字符串
...
--fskv.get(key, skey) - 根据key获取对应的数据
--传入值：
--string key的名称,必填,不能空字符串
