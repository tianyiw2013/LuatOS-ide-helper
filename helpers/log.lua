...
--log.debug(tag, val, val2, val3, ...) - 输出日志,级别debug
--传入值：
...
--log.info(tag, val, val2, val3, ...) - 输出日志,级别info
--传入值：
--string tag         日志标识,必须是字符串
--... 需打印的参数
--返回值：
...
--log.warn(tag, val, val2, val3, ...) - 输出日志,级别warn
--传入值：
--string tag         日志标识,必须是字符串
--... 需打印的参数
--返回值：
...
--log.error(tag, val, val2, val3, ...) - 输出日志,级别error
--传入值：
--string tag         日志标识,必须是字符串
--... 需打印的参数
--返回值：
